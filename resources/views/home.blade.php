        ...
        <div class="container mx-auto">
            ...
            <div class="flex text-center text-lg">
                <div class="w-1/3">
                    ...
                    <h4 class="font-bold text-xl">Crowdsources Convenience</h4>
                ...
                <div class="w-1/3">
                    ...
                    <h4 class="font-bold text-xl">Secure and Trustworthy</h4>
                ...
                <div class="w-1/3">
                    ...
                    <h4 class="font-bold text-xl">Eco-Friendly Logistics</h4>
    ...
    <div class="bg-gray-200 py-16 bg-no-repeat bg-cover bg-fixed" style="background-image: url({{ asset('asset/img/trust.jpg') }})">
        <div class="container">
            ...
            <div class="flex text-white gap-5">
                <div class="w-full sm:w-1/4 p-5 border rounded-lg">
