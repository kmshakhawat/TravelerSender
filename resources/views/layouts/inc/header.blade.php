    ...
    <div class="px-4 py-4">
        <div class="flex justify-between h-16">
            ...
            <div :class="menuOpen ? 'block' : 'hidden'" @click="menuOpen = false"
                 class="fixed z-20 inset-0 bg-black opacity-40 transition-opacity"></div>
            <!-- end::Black overlay -->
            ...
            <div class="flex items-center">
                @auth
                    ...
                    <aside
                        ...
                        class="fixed z-30 inset-y-0 right-0 w-72 transition duration-300 bg-white overflow-y-auto translate-x-0"
                    >
                        <div :class="menuOpen ? 'block' : 'hidden'" @click="menuOpen = false"
