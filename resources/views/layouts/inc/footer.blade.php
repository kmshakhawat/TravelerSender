<div class="border-t border-gray-300 text-lg">
    <div class="container mx-auto">
        <div class="flex flex-wrap -mx-4 justify-between py-8">
            <div class="w-full sm:w-1/2 lg:w-4/12 px-4 mb-4">
                ...
                <div class="flex gap-2 mb-5">
                    ...
                    Phone: <a href="tel:+44 XXXX XXXXXXXX">+44 XXXX XXXXXXXX</a>
                </div>
                <div class="flex gap-2 mb-5">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <div class="border-t border-gray-500 py-5">
            <div class="flex flex-col md:flex-row gap-5 md:gap-0 items-center">
                ...
                <div class="flex flex-col">
                    <div class="flex gap-5 mb-4 justify-center md:justify-end">
                        <a target="_blank" class="youtube" title="YouTube" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 text-gray-700" viewBox="0 0 16 16">
                        ...
                        <a target="_blank" class="twitter-x" title="X" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-6 text-gray-700" viewBox="0 0 16 16">
