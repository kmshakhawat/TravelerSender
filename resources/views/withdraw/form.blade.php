        ...
        <div class="bg-white p-6 rounded min-w-96">
            ...
            <div class="mt-6">
                <div class="mt-4">
                    ...
                    @else
                        <p>Please <a href="{{ route('profile') }}">click here</a> to update your bank details.</p>
                    @endif
                    <x-label for="status" value="{{ __('Amount') }}" />
                    <x-input id="amount" class="block w-full" type="text" name="amount" :value="$payment->net_amount" disabled autocomplete="amount" />
