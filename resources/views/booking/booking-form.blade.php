                        ...
                        <div class="flex flex-col sm:flex-row sm:gap-4">
                            <div class="w-full sm:w-1/3 mt-4">
                                ...
                                <div class="relative">
                                    ...
                                    <x-input id="friend_name" class="block w-full ps-10" type="text" name="friend_name" :value="old('friend_name')" autocomplete="friend_name" />
                                </div>
                            ...
                            <div class="w-full sm:w-1/3 mt-4">
                                ...
                                <div class="relative">
                                    ...
                                    <x-input id="friend_email" class="block w-full ps-10" type="email" name="friend_email" :value="old('friend_email')" autocomplete="friend_email" />
                                </div>
                            ...
                            <div class="w-full sm:w-1/3 mt-4">
                                ...
                                <div class="relative">
                                    ...
                                    <x-input id="friend_phone" class="block w-full ps-10 phone" type="text" name="friend_phone" :value="old('friend_phone')" autocomplete="friend_phone" />
                                </div>
