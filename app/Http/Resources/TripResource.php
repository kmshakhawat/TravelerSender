    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'from' => [
                ...
                'country_name' => $this->fromCountry?->name ?? '',
                'state_id' => $this->from_state_id,
                'state_name' => $this->fromState?->name ?? '',
                'city_id' => $this->from_city_id,
                'city_name' => $this->fromCity?->name ?? '',
            ...
            'to' => [
                ...
                'country_name' => $this->toCountry?->name ?? '',
                'state_id' => $this->to_state_id,
                'state_name' => $this->toState?->name ?? '',
                'city_id' => $this->to_city_id,
                'city_name' => $this->toCity?->name ?? '',
